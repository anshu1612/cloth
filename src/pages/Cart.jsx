...
const Cart = () => {
  ...
  const orders = {userId, products, amount, address: "India"}
...
async function displayRazorpay() {
        ...
        const result = await axios.post("https://clothvilla-api.onrender.com/payment/orders", {total: total});
        ...
        const options = {
            ...
            handler: async function (response) {
                ...
                const result = await axios.post("https://clothvilla-api.onrender.com/payment/success", data);
                dispatch(clearCart);
            ...
            prefill: {
                name: "shoppy",
                email: "shoppy@example.com",
                contact: "9999999999",
            },
            notes: {
                address: "shoppy Corporate Office",
            },
            theme: {
                color: "#61dafb",
            },
    ...
    <Container>
      ...
      <Wrapper>
        ...
        <Top>
          ...
          <TopButton  onClick={displayRazorpay} type="filled">CHECKOUT NOW</TopButton>
        </Top>
        <Bottom>
          <Info>
